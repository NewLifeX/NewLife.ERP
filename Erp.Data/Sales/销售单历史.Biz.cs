...
namespace Erp.Data.Sales
{
    public partial class SaleOrderHistory : Entity<SaleOrderHistory>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化SaleOrderHistory[销售单历史]数据……");

        //    var entity = new SaleOrderHistory();
        //    entity.OrderId = 0;
        //    entity.Action = "abc";
        //    entity.Remark = "abc";
        //    entity.TraceId = "abc";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化SaleOrderHistory[销售单历史]数据！");
        //}
