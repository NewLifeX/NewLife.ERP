...
namespace Erp.Data.Products
{
    public partial class ProductUnit : Entity<ProductUnit>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化ProductUnit[产品单元]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化ProductUnit[产品单元]数据！");
        //}
        ...
        public static IList<ProductUnit> Search(String code, DateTime start, DateTime end, String key, PageParameter page)
        {
