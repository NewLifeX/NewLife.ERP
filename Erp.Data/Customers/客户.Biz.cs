...
namespace Erp.Data.Customers
{
    ...
    public partial class Customer : Entity<Customer>
    {
        ...
        public static IList<Customer> Search(String name, DateTime start, DateTime end, String key, PageParameter page)
        {
            ...
            if (!key.IsNullOrEmpty()) exp &= _.FullName.Contains(key) | _.CreateUser.Contains(key) | _.CreateIP.Contains(key) | _.UpdateUser.Contains(key) | _.UpdateIP.Contains(key) | _.Remark.Contains(key);
