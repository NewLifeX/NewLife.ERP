...
{
    /// <summary>供应商。货物供应来源</summary>
    [Serializable]
    [DataObject]
    [Description("供应商。货物供应来源")]
    [BindIndex("IU_Supplier_Name", true, "Name")]
    [BindTable("Supplier", Description = "供应商。货物供应来源", ConnName = "Erp", DbType = DatabaseType.None)]
    public partial class Supplier
    {
        ...
        #region 字段名
        /// <summary>取得供应商字段信息的快捷方式</summary>
        ...
        /// <summary>取得供应商字段名称的快捷方式</summary>
